...
function collectGameSettingsForStorage(){
  return {
    ...
    seats: {
      1: {
        openEngineMode: getCpuOpenSeatModeSafe(1),
        openProfileKey: getCpuOpenSeatProfileKeySafe(1),
        discardEngineMode: getCpuDiscardSeatModeSafe(1),
        discardStyleKey: getCpuDiscardSeatStyleKeySafe(1)
      },
      2: {
        openEngineMode: getCpuOpenSeatModeSafe(2),
        openProfileKey: getCpuOpenSeatProfileKeySafe(2),
        discardEngineMode: getCpuDiscardSeatModeSafe(2),
        discardStyleKey: getCpuDiscardSeatStyleKeySafe(2)
      }
    }
  };
}
...
function loadGameSettingsFromStorage(){
  try{
    ...
    applyGameSettingsFromObject(parsed);
    return true;
  }catch(e){
    return false;
  }
