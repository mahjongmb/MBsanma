...
(function(){
  ...
  function getStoredLogs(){
    try{
      if (window.MBSanmaMatchLog && typeof window.MBSanmaMatchLog.getStoredLogs === "function"){
  ...
  function getMatchMode(log){
    ...
    if (raw === "normal" || raw === "play" || raw === "manual") return "normal";
  ...
  function buildAnalysisPanel(){
    ...
    panel.appendChild(buildAnalysisPanelInner());
    return panel;
  }
  ...
  function buildAnalysisPanelInner(){
    ...
    wrap.appendChild(buildAnalysisResultCard());
    return wrap;
  }

  function buildAnalysisResultCard(){
  ...
  function getStatsOverlay(){
    return document.getElementById("visitorStatsOverlay");
  }

  function getStatsHeaderTabs(){
    return document.getElementById("visitorStatsHeaderTabs");
  }

  function getStatsPanels(){
  ...
  function setOverlayActiveTab(tabKey){
    const headerTabs = getStatsHeaderTabs();
    const panels = getStatsPanels();
  ...
  function rerenderAnalysisPanel(){
    const panels = getStatsPanels();
    if (!panels) return;
